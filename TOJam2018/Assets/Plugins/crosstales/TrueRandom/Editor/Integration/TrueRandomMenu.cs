...
namespace Crosstales.TrueRandom.EditorIntegration
{
    ...
    public class TrueRandomMenu
    {
        ...
        private static void AddTrueRandom()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "Add " + Util.Constants.TRUERANDOM_SCENE_OBJECT_NAME);
        }
        ...
        private static void ShowManual()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_MANUAL_URL");
        }
        ...
        private static void ShowAPI()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_API_URL");
        }
        ...
        private static void ShowForum()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_FORUM_URL");
        }
        ...
        private static void ShowProduct()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_WEB_URL");
        }
        ...
        private static void ShowVideoPromo()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_VIDEO_PROMO");
        }
        ...
        private static void ShowVideoTutorial()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_VIDEO_TUTORIAL");
        }
        ...
        private static void ShowAllVideos()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_SOCIAL_YOUTUBE");
        }
        ...
        private static void ShowUAS()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_CT_URL");
        }
        ...
        private static void ShowCT()
        {
            ...
            GAApi.Event(typeof(TrueRandomMenu).Name, "ASSET_AUTHOR_URL");
        }
        ...
        private static void ShowInfo()
        {
            EditorUtility.DisplayDialog(Util.Constants.ASSET_NAME + " - About",
                ...
                System.Environment.NewLine +
                "© 2016-2018 by " + Util.Constants.ASSET_AUTHOR +
                System.Environment.NewLine +
                System.Environment.NewLine +
                Util.Constants.ASSET_AUTHOR_URL +
                System.Environment.NewLine, "Ok");

            GAApi.Event(typeof(TrueRandomMenu).Name, "Info");
        }
    }
}
