...
Follow these steps to upgrade your version of "True Random PRO":

1. Update "True Random PRO" to the latest version from the "Unity AssetStore"
2. Delete the "Assets/Plugins/crosstales/TrueRandom" folder from the Project-view
...
### Demos
* [WebGL-Demo](https://goo.gl/1RYXe7)
* [Android-Demo](https://www.crosstales.com/media/truerandom/TrueRandom.apk)

### Supported 3rd party assets
* [PlayMaker](https://www.assetstore.unity3d.com/#!/content/368?aid=1011lNGT)


`Version: 26.03.2018 15:59`