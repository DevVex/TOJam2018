...
namespace Crosstales.TrueRandom.Module
{
    ...
    public abstract class ModuleVector3 : BaseModule
    {
        ...
        public delegate void GenerateFinished(System.Collections.Generic.List<Vector3> result, string id);
        ...
        public static System.Collections.Generic.List<Vector3> Result
        {
            get
            {
                return new System.Collections.Generic.List<Vector3>(result);
            }
        }
        ...
        public static System.Collections.Generic.List<Vector3> GeneratePRNG(Vector3 min, Vector3 max, int number = 1)
        {
        ...
        private static void onGenerateFinished(System.Collections.Generic.List<Vector3> result, string id)
        {
            if (Util.Config.DEBUG)
